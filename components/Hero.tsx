...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#0B0B0B] text-white">
      {/* Background Glow */}
      <div className="absolute -left-32 top-10 h-72 w-72 rounded-full bg-yellow-400/10 blur-3xl"></div>
      <div className="absolute right-0 top-40 h-96 w-96 rounded-full bg-yellow-400/10 blur-3xl"></div>
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a
              ...
              className="rounded-xl border border-yellow-400 px-8 py-4 font-bold text-white transition hover:bg-yellow-400 hover:text-black"
            >
              WhatsApp
            </a>
