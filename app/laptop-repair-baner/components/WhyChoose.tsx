...
const features = [
  ...
  },
  {
    ...
    description:
      "Convenient pickup and drop service is available across Baner and nearby areas, subject to availability.",
  },
  {
    icon: IndianRupee,
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-white">
            Why Customers in Baner Trust Lappy Care
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-300">
            We provide trusted laptop repair services for students, working
            professionals, businesses and home users across Baner with quality
            workmanship, genuine guidance and transparent pricing.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-yellow-400 p-10">
          ...
          <div className="mx-auto mt-10 max-w-4xl text-center">
            <p className="text-lg leading-8 text-black/80">
              Lappy Care proudly serves customers across Baner, Balewadi,
              Pashan, Aundh, Sus, Mahalunge and nearby Pune areas. Whether you
              need motherboard repair, screen replacement, SSD upgrade, battery
              replacement, keyboard repair or data recovery, our experienced
