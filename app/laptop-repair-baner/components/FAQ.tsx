...
const faqs = [
  {
    question: "Do you provide laptop repair services in Baner?",
    answer:
      "Yes. Lappy Care provides professional laptop repair services across Baner, Balewadi, Pashan, Aundh, Sus and nearby Pune areas. Pickup & drop service is available for eligible locations.",
  },
  {
  ...
  {
    question: "How much does laptop repair cost in Baner?",
    answer:
      "Repair charges depend on the fault and required parts. After diagnosis, we provide a transparent estimate before starting any repair work.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We provide professional motherboard diagnostics and chip-level repair for many laptop models whenever repair is technically feasible.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Eligible repairs and replacement parts are covered by warranty. Warranty duration depends on the repair performed and the parts installed.",
  },
  {
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Laptop Repair Baner - FAQs
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Find answers to the most common questions about laptop repair
            services in Baner, including pricing, turnaround time, warranty,
            pickup & drop service and supported laptop brands.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-black p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-gray-300">
            Contact Lappy Care today for expert advice and professional laptop
            repair services in Baner. Our team will help diagnose your issue and
