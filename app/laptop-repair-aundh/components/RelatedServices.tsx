...
const services = [
  ...
  },
  {
    title: "SSD Upgrade",
    description:
      "Upgrade your laptop with a high-speed SSD for faster performance.",
    href: "/services/ssd-upgrade",
  },
  {
    title: "RAM Upgrade",
    description:
      "Increase your laptop's memory for smoother multitasking and better speed.",
    href: "/services/ram-upgrade",
  },
  {
    title: "Data Recovery",
    description:
      "Recover important data from damaged laptops, HDDs and SSDs.",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg text-gray-600">
            ...
            available for customers in Aundh and across Pune.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-black px-8 py-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
            ...
            RAM upgrades and professional data recovery, Lappy Care provides
            reliable laptop repair services with experienced technicians and
            transparent pricing.
          </p>
