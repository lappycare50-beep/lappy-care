      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-4xl font-bold text-gray-900">
            Areas We Serve Around Aundh
          </h2>

          <p className="mt-6 text-lg text-gray-600">
            Lappy Care provides professional laptop repair services across
            Aundh and nearby Pune locations with experienced technicians,
        ...
        <div className="mt-16 rounded-3xl bg-black px-8 py-12 text-center">
          <h3 className="text-3xl font-bold text-white">
            Laptop Repair Near You in Aundh
          </h3>

          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
            Whether you're in Aundh, Baner, Pashan, Balewadi, Wakad,
            Pimple Nilakh, Pimple Saudagar, Bavdhan or nearby areas,
            our experienced technicians provide reliable laptop repair
            services with fast turnaround and genuine replacement parts.
          </p>
