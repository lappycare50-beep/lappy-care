      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <span className="inline-flex items-center rounded-full border border-yellow-400/20 bg-yellow-400/10 px-4 py-2 text-sm font-semibold text-yellow-400">
            Trusted Laptop Repair Service in Aundh
          </span>

          <h1 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Laptop Repair in Aundh
          </h1>

          <p className="mt-6 text-lg leading-8 text-gray-300">
            Lappy Care provides professional laptop repair services in Aundh
            for Dell, HP, Lenovo, ASUS, Acer, Apple MacBook and other major
            laptop brands. We specialize in motherboard repair, screen
            replacement, battery replacement, SSD & RAM upgrades, keyboard
            repair, software installation and data recovery with fast
