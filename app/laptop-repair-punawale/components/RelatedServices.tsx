...
const services = [
  ...
  },
  {
    ...
    description:
      "Complete laptop repair services for hardware and software issues in Punawale.",
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Complete Laptop Repair Services in Punawale
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Lappy Care offers comprehensive laptop repair services in
            Punawale, including motherboard repair, screen replacement,
            SSD upgrades, RAM upgrades, battery replacement, keyboard
            replacement and professional data recovery.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-black p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-4xl text-lg leading-8 text-gray-300">
            ...
            provides trusted laptop repair services across Punawale,
            Tathawade, Ravet, Kiwale, Nigdi, Akurdi, Wakad and nearby Pune
            locations.
          </p>
        </div>
      </div>
