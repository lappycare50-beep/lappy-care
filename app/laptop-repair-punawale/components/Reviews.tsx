...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "My HP laptop screen was replaced on the same day. Pickup and delivery service was fast and very convenient.",
  },
  {
    name: "Amit Patil",
    location: "Ravet",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Highly recommended for laptop repair near Punawale. Friendly staff, quality work and excellent customer service.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Trusted by Customers Across Punawale
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Customers across Punawale trust Lappy Care for professional laptop
        ...
        <div className="mt-16 rounded-3xl bg-black p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-gray-300">
            ...
            across Punawale, Tathawade, Ravet, Kiwale, Nigdi, Akurdi,
            Wakad and nearby Pune locations.
          </p>
        </div>
      </div>
    </section>
