    ...
    <section className="relative overflow-hidden bg-black text-white">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 py-20 text-center lg:px-8">
        ...
        <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-6xl">
          Laptop Repair in{" "}
          <span className="text-yellow-400">Ravet</span>
        </h1>

        <p className="mt-6 max-w-3xl text-lg text-gray-300 md:text-xl">
          Professional laptop repair services in Ravet for Dell, HP, Lenovo,
          ASUS, Acer, Apple MacBook and other leading laptop brands. We provide
          motherboard repair, screen replacement, SSD & RAM upgrades, battery
          replacement and reliable data recovery services.
        </p>
