...
const services = [
  {
    ...
    description:
      "Professional replacement for cracked, flickering, damaged or dead laptop screens using high-quality compatible displays.",
  },
  {
    icon: Cpu,
    title: "Motherboard Repair",
    description:
      "Advanced chip-level motherboard diagnosis and repair performed by experienced technicians.",
  },
  {
    icon: BatteryCharging,
    title: "Battery Replacement",
    description:
      "Replace weak, swollen or fast-draining laptop batteries with reliable replacement batteries.",
  },
  {
    icon: HardDrive,
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-4xl font-bold text-gray-900">
            Professional Laptop Repair Services in Ravet
          </h2>

          <p className="mt-6 text-lg text-gray-600">
            Lappy Care provides reliable laptop repair services for students,
            professionals, businesses and home users across Ravet and nearby
            areas. We repair all major laptop brands using professional tools,
            quality spare parts and experienced technicians.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-black px-8 py-12 text-center text-white">
          <h3 className="text-3xl font-bold">
            Need Fast Laptop Repair in Ravet?
          </h3>

          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Book your laptop repair today for expert diagnostics, transparent
            pricing, genuine spare parts and convenient pickup & drop service
            for eligible locations in and around Ravet.
          </p>
