...
const services = [
  {
    ...
    description:
      "Fast replacement for cracked, damaged or flickering laptop displays.",
  ...
  },
  {
    ...
    description:
      "Professional chip-level motherboard diagnosis and repair.",
  ...
  },
  {
    ...
    description:
      "Replace weak or swollen laptop batteries with quality replacements.",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-4xl font-bold text-gray-900">
            Complete Laptop Repair Services in Ravet
          </h2>

          <p className="mt-6 text-lg text-gray-600">
            Lappy Care offers complete laptop repair solutions for customers
            across Ravet, including hardware repairs, software troubleshooting,
            upgrades and professional data recovery services.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-black px-8 py-12 text-center text-white">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-gray-300">
            ...
            provides dependable laptop repair services throughout Ravet and
            nearby areas.
          </p>
