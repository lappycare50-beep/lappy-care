...
const steps = [
  {
    ...
    description:
      "Our technicians carefully inspect your laptop to identify hardware or software issues before starting the repair.",
  },
  {
    icon: FileCheck,
    title: "Repair Estimate",
    description:
      "We provide a transparent repair estimate after diagnosis so you know the repair cost before any work begins.",
  },
  {
    icon: Wrench,
  ...
  },
  {
    ...
    description:
      "Every repaired laptop is thoroughly tested before delivery to ensure reliable performance and customer satisfaction.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-4xl font-bold text-gray-900">
            Our Laptop Repair Process in Pimple Saudagar
          </h2>
