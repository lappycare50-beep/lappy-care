        ...
        <div className="overflow-hidden rounded-3xl border border-yellow-400/20 bg-gradient-to-br from-gray-900 to-black p-10 lg:p-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold tracking-tight text-white lg:text-5xl">
              Need Professional Laptop Repair in Pimple Saudagar?
            </h2>
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-300">
              ...
              issue, Lappy Care provides reliable laptop repair services with
            ...
            <p className="mt-10 text-sm leading-7 text-gray-400">
              Proudly serving Pimple Saudagar, Rahatani, Pimple Gurav,
              Vishal Nagar, Wakad, Baner, Aundh, Kalewadi, Sangvi,
              Hinjawadi, Pimpri and nearby Pune locations.
            </p>
          </div>
        </div>
      </div>
