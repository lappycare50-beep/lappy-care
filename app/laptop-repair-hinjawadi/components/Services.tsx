      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Professional Laptop Repair Services in Hinjawadi
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            We provide reliable laptop repair solutions for students,
            professionals, startups and businesses across Hinjawadi. Our
            certified technicians repair all major laptop brands using quality
            spare parts and modern diagnostic tools.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-black p-10 text-center">
          <h3 className="text-3xl font-bold text-yellow-400">
            Need Fast Laptop Repair in Hinjawadi?
          </h3>
