      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-12 px-6 py-20 lg:flex-row lg:px-8">
        ...
        <div className="flex-1">
          <span className="inline-flex rounded-full border border-yellow-500/40 bg-yellow-500/10 px-4 py-1 text-sm font-semibold text-yellow-400">
            Professional Chip-Level Motherboard Repair
          </span>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
            Is your laptop completely dead, not turning on, showing no display,
            restarting randomly or affected by liquid damage? Lappy Care offers
            professional chip-level laptop motherboard repair for HP, Dell,
            Lenovo, ASUS, Acer, Apple MacBook, MSI and all major laptop brands
            using advanced diagnostic tools and experienced technicians.
          </p>
          ...
          <div className="w-full rounded-3xl border border-yellow-500/20 bg-zinc-900 p-8 shadow-2xl">
            ...
            <div className="mt-8 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    We diagnose and repair motherboard faults including power
                    circuits, charging ICs, display circuits, BIOS issues and
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Every motherboard is thoroughly inspected before repair to
                    identify the exact fault and recommend the most effective
                    solution.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Eligible motherboard repairs are backed by warranty based on
                    the repaired components and service performed.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 rounded-xl bg-yellow-400 p-4 text-center text-black">
              ...
              <p className="text-sm">
                ...
                Tathawade • Ravet • Aundh • Pashan • Bavdhan •
                Chinchwad • Pimpri • Pimple Saudagar
              </p>
            </div>
          </div>
        </div>
