      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Professional Laptop Repair Services in Balewadi
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Lappy Care provides trusted laptop repair services for students,
            working professionals, businesses and home users across Balewadi.
            Our certified technicians repair all major laptop brands using
            professional diagnostic tools and high-quality replacement parts.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-3xl bg-black p-10 text-center">
          <h3 className="text-3xl font-bold text-yellow-400">
            Need Fast Laptop Repair in Balewadi?
          </h3>
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-gray-300">
            ...
            laptop repair services in Balewadi with quick turnaround,
            transparent pricing and pickup & drop support in eligible areas.
          </p>
