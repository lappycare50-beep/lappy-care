...
const faqs = [
  {
    question: "Do you provide laptop repair services in Balewadi?",
    answer:
      "Yes. Lappy Care provides professional laptop repair services across Balewadi, Baner, Mahalunge, Sus, Aundh, Pashan and nearby Pune areas. Pickup & drop service is available for eligible locations.",
  },
  {
  ...
  {
    question: "How much does laptop repair cost in Balewadi?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Laptop Repair Balewadi – FAQs
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Find answers to the most common questions about laptop repair
            services in Balewadi, including pricing, turnaround time,
        ...
        <div className="mt-16 rounded-3xl bg-black p-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-gray-300">
            ...
            laptop repair services in Balewadi. Our technicians will diagnose
