...
const locations = [
  ...
  },
  {
    ...
    description:
      "Professional laptop repair and computer services in Aundh.",
  },
  {
    name: "Laptop Repair Pashan",
    href: "/laptop-repair-pashan",
    description:
      "Reliable laptop repair, SSD upgrades and motherboard repair in Pashan.",
  },
  {
    name: "Laptop Repair Tathawade",
    href: "/laptop-repair-tathawade",
    description:
      "Fast and reliable laptop repair services for homes and businesses.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-gray-900">
            Laptop Repair Services Near Balewadi
          </h2>

          <p className="mt-5 text-lg leading-8 text-gray-600">
            Lappy Care proudly serves customers across Balewadi and nearby Pune
        ...
        <div className="mt-16 rounded-3xl bg-black p-10 text-center">
          <h3 className="text-3xl font-bold text-yellow-400">
            Serving Balewadi & Nearby Areas
          </h3>

          <p className="mx-auto mt-4 max-w-4xl text-lg leading-8 text-gray-300">
            We regularly provide laptop repair services across Balewadi,
            Baner, Mahalunge, Sus, Aundh, Pashan, Wakad, Hinjawadi and
            surrounding Pune locations with expert technicians, genuine
            guidance and transparent pricing.
          </p>
        </div>
      </div>
    </section>
