  ...
  return (
    <section className="bg-black py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="overflow-hidden rounded-3xl border border-yellow-400/20 bg-gradient-to-br from-gray-900 via-black to-gray-900 p-10 md:p-16 text-center">
          ...
          <h2 className="mt-6 text-4xl font-bold leading-tight text-white md:text-5xl">
            Need Professional Laptop Repair in Balewadi?
          </h2>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-300">
            ...
            services across Balewadi and nearby Pune locations.
          </p>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl bg-white/5 p-6">
              ...
              <p className="mt-3 leading-7 text-gray-300">
                Fast diagnosis and quick repairs for most common laptop
                issues, subject to parts availability.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white/5 p-6">
              ...
              <p className="mt-3 leading-7 text-gray-300">
                Transparent repair estimates, quality replacement parts and
            ...
            <div className="rounded-2xl bg-white/5 p-6">
              ...
              <p className="mt-3 leading-7 text-gray-300">
                ...
                Balewadi and nearby Pune areas.
              </p>
            </div>
          </div>
