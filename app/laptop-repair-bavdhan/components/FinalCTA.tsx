          ...
          <div className="grid items-center gap-12 px-8 py-14 lg:grid-cols-2 lg:px-14">
            ...
            <div>
              <span className="inline-flex rounded-full bg-yellow-400/10 px-4 py-2 text-sm font-semibold text-yellow-400">
                Trusted Laptop Repair in Bavdhan
              </span>

              <h2 className="mt-6 text-4xl font-bold leading-tight text-white lg:text-5xl">
                Need Fast & Reliable Laptop Repair in Bavdhan?
              </h2>

              <p className="mt-6 text-lg leading-8 text-gray-300">
                Whether your laptop has a broken screen, motherboard issue,
                charging problem, battery failure, keyboard damage or needs an
                SSD/RAM upgrade, Lappy Care offers professional diagnostics,
            ...
            <div className="rounded-3xl bg-white p-8 shadow-2xl">
              ...
              <p className="mt-4 leading-7 text-gray-600">
                Get a fast diagnosis, transparent repair estimate and reliable
                repair service from experienced laptop technicians.
              </p>
              ...
              <div className="mt-8 rounded-2xl bg-gray-50 p-5">
                <p className="text-sm leading-6 text-gray-600">
                  ...
                  Bavdhan, Kothrud, Chandani Chowk, Pashan, Sus,
                  Baner, Aundh, Warje, Bhugaon, Bhukum,
                  Mahalunge and nearby Pune locations.
                </p>
              </div>
            </div>
          </div>
