      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-4xl font-bold text-gray-900">
            Professional Laptop Repair Services in Chinchwad
          </h2>

          <p className="mt-6 text-lg text-gray-600">
            We provide complete laptop repair solutions for students,
            professionals, businesses and gamers across Chinchwad with
            experienced technicians, quality parts and transparent pricing.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-3xl bg-black px-8 py-12 text-center">
          <h3 className="text-3xl font-bold text-white">
            Need Fast Laptop Repair in Chinchwad?
          </h3>

          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
            Book your laptop repair today and let our experienced technicians
            diagnose and repair your device quickly with genuine parts and
