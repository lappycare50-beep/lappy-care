        ...
        <div className="overflow-hidden rounded-3xl border border-yellow-400/20 bg-gradient-to-br from-gray-900 to-black p-10 lg:p-16">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold tracking-tight text-white lg:text-5xl">
              Need Professional Laptop Repair in Chinchwad?
            </h2>

            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-300">
              Whether your laptop has a broken screen, motherboard issue,
              charging problem, battery failure, keyboard damage or software
              issue, Lappy Care provides reliable laptop repair services in
              Chinchwad with experienced technicians, transparent pricing,
            ...
            <p className="mt-10 text-sm leading-7 text-gray-400">
              Proudly serving Chinchwad, Akurdi, Nigdi, Pimpri, Thergaon,
              Ravet, Punawale, Tathawade, Kalewadi, Pimple Saudagar,
              Wakad, Baner and nearby PCMC locations.
            </p>
          </div>
        </div>
      </div>
